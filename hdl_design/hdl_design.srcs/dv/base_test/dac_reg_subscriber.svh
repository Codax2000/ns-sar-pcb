class dac_reg_subscriber extends spi_reg_subscriber;

    `uvm_component_utils(dac_reg_subscriber)

    dac_regs regmodel;

    // Constructor
    function new(string name = "dac_reg_subscriber", uvm_component parent = null);
