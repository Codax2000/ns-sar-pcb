...
class base_test extends uvm_test;
    ...
    virtual function void create_base_test_config();
    ...
    virtual function void build_chip_ral();
        m_ral = chip_top::type_id::create("m_ral", this);
        m_ral.build();
        m_ral.lock_model();
        m_ral.reset();
    endfunction
    ...
    virtual function void assign_spi_env_rals();
        ...
        m_dac_spi_env_cfg.m_reg_env_cfg.m_ral = m_ral.DAC;
    endfunction
    ...
    virtual task main_phase(uvm_phase phase);
        ...
        m_ral.DAC.ENABLE.dacp_enable.set(1);
        m_ral.DAC.ENABLE.update(status);
        if (status == UVM_NOT_OK)
        ...
        `uvm_info(get_full_name(), $sformatf("ADC Conversion Flags: 0x%0h", m_ral.ADC.CONVERSION_FLAGS.get()), UVM_LOW);
