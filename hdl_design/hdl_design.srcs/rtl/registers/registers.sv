module registers(
    ...
    always_ff @(posedge clk or negedge rst_b) begin
        if (!rst_b)
            ...
            i0.N_SAR_CYCLES <= bus_if_wr_data[13:0];
    end
    ...
    always_ff @(posedge clk or negedge rst_b) begin
        if (!rst_b)
            ...
            case (bus_if_rd_addr)
                ...
                5 : bus_if_rd_data <= '{1'b0, 1'b0, i0.N_SAR_CYCLES[13], i0.N_SAR_CYCLES[12], i0.N_SAR_CYCLES[11], i0.N_SAR_CYCLES[10], i0.N_SAR_CYCLES[9], i0.N_SAR_CYCLES[8], i0.N_SAR_CYCLES[7], i0.N_SAR_CYCLES[6], i0.N_SAR_CYCLES[5], i0.N_SAR_CYCLES[4], i0.N_SAR_CYCLES[3], i0.N_SAR_CYCLES[2], i0.N_SAR_CYCLES[1], i0.N_SAR_CYCLES[0]};
